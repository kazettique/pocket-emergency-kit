...
export const strings = {
  ...
  'home.jmaHeadline': { ja: '気象情報サマリ', en: 'Weather summary' },
  'home.jmaAreas': { ja: '対象地域', en: 'Affected areas' },
  'home.jmaStatus': { ja: 'ステータス', en: 'Status' },
  'home.jmaIssuedAt': { ja: '発表時刻', en: 'Issued at' },
  'home.jmaStatusIssued': { ja: '発表', en: 'Issued' },
  'home.jmaStatusContinuing': { ja: '継続', en: 'Continuing' },
  'home.jmaStatusCleared': { ja: '解除', en: 'Cleared' },
  'home.jmaSeverityEmergency': { ja: '特別警報', en: 'Emergency warning' },
  'home.jmaSeverityWarning': { ja: '警報', en: 'Warning' },
  'home.jmaSeverityAdvisory': { ja: '注意報', en: 'Advisory' },
  'home.jmaAreaCount': { ja: '{n}地域', en: '{n} areas' },
